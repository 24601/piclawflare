...
function isAuthorized(req) {
    ...
    if (!config.internalSecret) {
        ...
        log.error("Cloudflare internal endpoints are enabled but PICLAW_CF_INTERNAL_SECRET is not configured; denying /_cf/* request.", { operation: "is_authorized.no_secret" });
        return false;
    }
